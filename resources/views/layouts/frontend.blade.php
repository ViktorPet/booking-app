...
<head>
    ...
    <link rel="stylesheet" href="{{asset('dist/plugins/revslider/css/settings.css')}}">
...
--}}
    ...
    <link rel="stylesheet" href="{{asset('dist/css/travlez-jquery-ui.css')}}">
    <link rel="stylesheet" href="{{asset('dist/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('dist/css/responsive.css')}}">
    <link rel="stylesheet" href="{{asset('dist/css/sb-admin.css')}}">
...
--}}
   ...
   {{-- <script type="text/javascript" src="js/sticky-sidebar.js"></script>--}}
    ...
    <script src="{{asset('dist/plugins/revslider/js/jquery.themepunch.tools.min.js')}}"></script>
    <script src="{{asset('dist/plugins/revslider/js/jquery.themepunch.revolution.min.js')}}"></script>
    ...
    <script src="{{asset('dist/plugins/revslider/js/extensions/revolution.extension.actions.min.js')}}"></script>
    <script src="{{asset('dist/plugins/revslider/js/extensions/revolution.extension.carousel.min.js')}}"></script>
    <script src="{{asset('dist/plugins/revslider/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
    <script src="{{asset('dist/plugins/revslider/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
    <script src="{{asset('dist/plugins/revslider/js/extensions/revolution.extension.migration.min.js')}}"></script>
    <script src="{{asset('dist/plugins/revslider/js/extensions/revolution.extension.navigation.min.js')}}"></script>
    <script src="{{asset('dist/plugins/revslider/js/extensions/revolution.extension.parallax.min.js')}}"></script>
    <script src="{{asset('dist/plugins/revslider/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
    <script src="{{asset('dist/plugins/revslider/js/extensions/revolution.extension.video.min.js')}}"></script>
   ...
   {{-- <script type="text/javascript" src="plugins/revslider/js/extensions/revolution.extension.actions.min.js"></script>
    ...
    <style type="text/css">
        ...
        .active{
            background-image: url("{{ public_path('images/star_1.png') }}");
        }
